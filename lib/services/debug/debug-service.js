...
/**
 * Checks whether ScormCloud is available.
 * 
...
/**
 * Checks whether the AppId and SecretKey are authorised.
 * 
 * @param  {Function} callback Method to invoke with response.
 */
DebugService.prototype.authPing = function(callback){
  var method = new ServiceRequest.RequestMethod(this.configuration_, {
    method: DebugService.serviceMethods.authPing
  });
